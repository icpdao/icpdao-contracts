...
import { DAOToken, DAOToken__factory, INonfungiblePositionManager } from '../typechain';
...
import { FeeAmount, Position, TICK_SPACINGS, Pool, priceToClosestTick, TickMath, nearestUsableTick } from '@uniswap/v3-sdk';
import { abi as nonfungiblePositionManagerABI } from '../artifacts/contracts/interfaces/external/INonfungiblePositionManager.sol/INonfungiblePositionManager.json';
...
describe("IcpdaoDaoToken", () => {
    ...
    before("init", async () => {
        ...
        weth9 = (await ethers.getContractAt(weth9Abi, weth9Address))
