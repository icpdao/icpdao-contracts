...
describe("IcpdaoDaoToken.rule.2", () => {
    ...
    before("init", async () => {
        ...
        daoFactory = (await daoFactory_.deploy(deployAccount.address)) as DAOFactory;
        expect(
        ...
        icpdaoDaoToken = (await ethers.getContractAt(IcpdaoDaoTokenABI, await daoFactory.tokens('ICP'))) as DAOToken;
        ...
        await (await helloToken.connect(ownerAccount).approve(icpdaoDaoToken.address, MaxUint256.toString())).wait()
        ...
        icpdaoDaoTokenForLink = (await ethers.getContractAt(IcpdaoDaoTokenABI, await daoFactory.tokens('ICPFL'))) as DAOToken;
        ...
        await (await helloToken.connect(ownerAccount).approve(icpdaoDaoTokenForLink.address, MaxUint256.toString())).wait()
        ...
        icpdaoDaoTokenForUpdate = (await ethers.getContractAt(IcpdaoDaoTokenABI, await daoFactory.tokens('ICPFU'))) as DAOToken;
        ...
        await (await helloToken.connect(ownerAccount).approve(icpdaoDaoTokenForUpdate.address, MaxUint256.toString())).wait()
        ...
        icpdaoDaoTokenForNoPool = (await ethers.getContractAt(IcpdaoDaoTokenABI, await daoFactory.tokens('ICPFNP'))) as DAOToken;
        ...
        await (await helloToken.connect(ownerAccount).approve(icpdaoDaoTokenForNoPool.address, MaxUint256.toString())).wait()
        ...
        icpdaoDaoTokenForBonusWithdraw = (await ethers.getContractAt(IcpdaoDaoTokenABI, await daoFactory.tokens('ICPFBW'))) as DAOToken;
        ...
        await (await helloToken.connect(ownerAccount).approve(icpdaoDaoTokenForBonusWithdraw.address, MaxUint256.toString())).wait()
        ...
        icpdaoDaoTokenForBonusWithdrawByTokenIdList = (await ethers.getContractAt(IcpdaoDaoTokenABI, await daoFactory.tokens('ICPFBWL'))) as DAOToken;
        ...
        await (await helloToken.connect(ownerAccount).approve(icpdaoDaoTokenForBonusWithdrawByTokenIdList.address, MaxUint256.toString())).wait()
    ...
    it("createLPPoolOrLinkLPPool create", async () => {
        ...
        if (icpdaoDaoToken.address == (position as Position).amount0.currency.address) {
            console.log("icpdaoDaoToken", "1111")
            ...
            console.log("icpdaoDaoToken", "2222")
        ...
        ).to.be.revertedWith("ICPDAO: LP POOL ALREADY EXISTS");
    ...
    it("createLPPoolOrLinkLPPool link", async () => {
        const [mockPool, position] = getCreatePoolAndPosition(
            FeeAmount.LOW,
            icpdaoDaoTokenForLink.address, helloToken.address,
        ...
        if (icpdaoDaoTokenForLink.address == (position as Position).amount0.currency.address) {
            console.log("icpdaoDaoTokenForLink", "1111")
            baseTokenAmount = (position as Position).mintAmounts.amount0.toString();
            quoteTokenAmount = (position as Position).mintAmounts.amount1.toString();
        } else {
            console.log("icpdaoDaoTokenForLink", "2222")
            baseTokenAmount = (position as Position).mintAmounts.amount1.toString();
            quoteTokenAmount = (position as Position).mintAmounts.amount0.toString()
        }
        ...
        await (await helloToken.connect(ownerAccount).approve(nonfungiblePositionManager.address, MaxUint256.toString())).wait()
    ...
    it("updateLPPool", async () => {
        ...
        ).to.be.revertedWith("ICPDAO: LP POOL DOES NOT EXIST");

        const [mockPool, position] = getCreatePoolAndPosition(
            FeeAmount.LOW,
            icpdaoDaoTokenForUpdate.address, helloToken.address,
        ...
        if (icpdaoDaoTokenForUpdate.address == (position as Position).amount0.currency.address) {
            console.log("icpdaoDaoTokenForUpdate", "1111")
            baseTokenAmount = (position as Position).mintAmounts.amount0.toString();
            quoteTokenAmount = (position as Position).mintAmounts.amount1.toString();
        } else {
            console.log("icpdaoDaoTokenForUpdate", "2222")
            baseTokenAmount = (position as Position).mintAmounts.amount1.toString();
            quoteTokenAmount = (position as Position).mintAmounts.amount0.toString()
        }
        ...
        ).to.be.revertedWith("ICPDAO: NOT ENOUGH TEMPORARYAMOUNT")
    ...
    it("mint have pool", async () => {
        ...
        ).to.revertedWith("NOT OWNER OR MANAGER")
        ...
        ).to.revertedWith("ICPDAO: MINT START TIMESTAMP != LAST MINT TIMESTAMP")
        ...
        ).to.revertedWith("ICPDAO: MINT TIMESTAMP > BLOCK TIMESTAMP")
        ...
        ).to.revertedWith("ICPDAO: MINT TIMESTAMP < LAST MINT TIMESTAMP")
    ...
    it("bonusWithdraw", async () => {
        ...
        ).to.revertedWith("ICPDAO: NO POOL")
        const [mockPool, position] = getCreatePoolAndPosition(
            FeeAmount.LOW,
            icpdaoDaoTokenForBonusWithdraw.address, helloToken.address,
        ...
        if (icpdaoDaoTokenForBonusWithdraw.address == (position as Position).amount0.currency.address) {
            console.log("icpdaoDaoTokenForBonusWithdraw", "1111")
            baseTokenAmount = (position as Position).mintAmounts.amount0.toString();
            quoteTokenAmount = (position as Position).mintAmounts.amount1.toString();
        } else {
            console.log("icpdaoDaoTokenForBonusWithdraw", "2222")
            baseTokenAmount = (position as Position).mintAmounts.amount1.toString();
            quoteTokenAmount = (position as Position).mintAmounts.amount0.toString()
        }
        ...
        await (await helloToken.connect(user3Account).approve(swapRouter.address, MaxUint128)).wait();
        await (await helloToken.connect(ownerAccount).transfer(user3Account.address, BigNumber.from(10).pow(18).mul(10)))

        for (let i = 0; i <= 2; i++){
            const tx6 = await swapRouter.connect(user3Account).exactInputSingle(
                {
                    tokenIn: helloToken.address,
        ...
        ).to.revertedWith("ICPDAO: NOT _staking")

        await (await daoFactory.setStaking(stakingAddress)).wait()
    ...
    it("bonusWithdrawByTokenIdList", async () => {
        ...
        const [mockPool, position] = getCreatePoolAndPosition(
            FeeAmount.LOW,
            icpdaoDaoTokenForBonusWithdrawByTokenIdList.address, helloToken.address,
        ...
        if (icpdaoDaoTokenForBonusWithdrawByTokenIdList.address == (position as Position).amount0.currency.address) {
            console.log("icpdaoDaoTokenForBonusWithdrawByTokenIdList", "1111")
            baseTokenAmount = (position as Position).mintAmounts.amount0.toString();
            quoteTokenAmount = (position as Position).mintAmounts.amount1.toString();
        } else {
            console.log("icpdaoDaoTokenForBonusWithdrawByTokenIdList", "2222")
            baseTokenAmount = (position as Position).mintAmounts.amount1.toString();
            quoteTokenAmount = (position as Position).mintAmounts.amount0.toString()
        }
        ...
        expect(after1.sub(before1)).to.eq("1237295848")
        expect(after2.sub(before2)).to.eq("122492288987")
    })
    ...
    it("transferOwnership", async () => {
        ...
        ).to.revertedWith("ICPDAO: NOT OWNER")
        await expect(
        ...
        ).to.revertedWith("ICPDAO: NEW OWNER INVALID")
        expect(
